...
* Francesco Mecatti
*
* Program to encrypt and decrypt integers through the RSA algorithm.
*
*/
		...
		switch (ch) {
			...
			case 2:  // cifratura
				cout
					...
					<< "Numero: ";
				cin >> m;
				cout << "Numero intero cifrato: " << rsa(m, e, r) << endl;
				break;
			case 3:  // decifratura
				cout
					<< endl
					<< "Numero: ";
				cin >> m;
				cout << "Numero intero decifrato: " << rsa(m, d, r) << endl;
				break;
			case 4:
				return 0;
			default:
...
int menu(int e, int d, int r) {
	cout
		...
		<< "2. Cifratura numero" << endl
		<< "3. Decifratura numero" << endl
		<< "4. Exit" << endl
		<< ">> ";
